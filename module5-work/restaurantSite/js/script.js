...
(function (global) {
    ...
    // 'categoryShort' is a short_name of a category
    ...
    function buildAndShowMenuItemsHTML (categoryMenuItems) {
        // Load title snipped of menu items page
        $ajaxUtils.sendGetRequest(
            menuItemsTitleHtml,
    ...
    // Using category and menu items data and snippets html build items view HTML to be inserted into page
